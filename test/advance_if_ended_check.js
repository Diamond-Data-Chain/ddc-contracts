...
async function main() {
  console.log("=== ADVANCE IF ENDED CHECK ===");
  ...
  console.log("before:", (await presale.currentBatchId()).toString());
  ...
  console.log("after:", (await presale.currentBatchId()).toString());

  if ((await presale.currentBatchId()) !== 2n) {
    throw new Error("batch did not advance");
  }

  console.log("ADVANCE IF ENDED CHECK PASSED");
}
